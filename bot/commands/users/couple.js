const { SlashCommandBuilder } = require('@discordjs/builders'),
	...
	canvas = Canvas.createCanvas(260, 128),
	// 384, 128
...
module.exports = {
	...
	async execute(interaction) {
		...
		ctx.drawImage(foto1, 3, 0, 128, 128);
		// -10, 0, 128, 128 //5 fica muito bom, mas notavel pra direita
		ctx.drawImage(foto2, 130, 0, 128, 128);
		// 260, 0, 128, 128
